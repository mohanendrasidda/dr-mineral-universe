# Canon — Character Registry

Living continuity file. **Consult before introducing any character; update after establishing one.**
Seeded from `docs/02_canon-registry.md` (Universe Bible v1.0). Related: [departments](departments.md) · [lore-ledger](lore-ledger.md) · [visual-canon](visual-canon.md).

| Name | Species | Department / Role | Defining trait | Voice notes | First appearance |
|---|---|---|---|---|---|
| **Dr. Mineral** | Campus squirrel | Founder & Chief Researcher, Hidden Laboratory | Humble, curious, collaborative; collects discoveries, not treasure | Warm, wondering, never boastful; asks more than he answers; still calls himself a student | Book I, Ch 1 |
| **Tally** | Magpie (corvid) | Apprentice, Contribution Registry — **Book I co-lead** | Eager, bright, brave; says the true thing before learning it can't be done; embodies "every contribution matters." Above ground magpies are mocked as thieves/hoarders — her gift is the opposite of forgetting | Curious, fast-talking, asks the questions the reader has; learns by Dr. Mineral's example. Her button-string childhood gives her the "chain" insight | Book I, Ch 3 |
| **Vellum** | Tortoise (ancient) | **Keeper of the Contribution Registry** (the laboratory's memory); Tally's mentor | Patient past all hurry; venerable; never startled in 300 years until the unsigned seed. Caution born of love, not obstruction. Learns he is "only one link" too | Slow, deep, tired-but-kind; speaks rarely and weightily | Book I, Ch 3 |
| **Old Hazel** | (historical, species TBD) | Founding-age keeper, celebrated in the Archives as "she who brought the seed down" | A real, beloved keeper who carried the seed down one snowy stair — but NOT its sole saver; the tale collapsed a long relay into one heroine | Known only through illuminated Archive pages | Book I (historical, Ch 9–10) |
| *(open)* | — | Lead, Mineral Sciences | — | — | — |
| *(open)* | — | Lead, Robotics Division | — | — | — |
...
## Casting rules
- Each department is run by specialists of different animal species; species should fit the science (and the reason should be sayable in one line).
- Dr. Mineral is always humble, curious, collaborative — never revenge/fame/power.
- Add new characters here with species, role, defining trait, voice, and first appearance. Never silently retcon an established trait — flag a deliberate canon change.
