...
<section style="position:relative; min-height:60vh; display:flex; align-items:flex-end; overflow:hidden; border-bottom:1px solid rgba(210,170,110,.16);">
 <img src="../../assets/environments/{slug}.png" alt="{name}" style="position:absolute; inset:0; width:100%; height:100%; object-fit:cover;">
 <div style="position:absolute; inset:0; background:linear-gradient(180deg, rgba(10,8,7,.28) 0%, rgba(10,8,7,.5) 55%, rgba(10,8,7,.96) 100%);"></div>
 <div style="position:relative; max-width:980px; margin:0 auto; width:100%; padding:0 24px 48px;">
  ...
  <h1 style="margin:14px 0 10px; font-family:'Cormorant Garamond',serif; font-weight:600; font-size:clamp(42px,8vw,84px); line-height:1; color:#f5e8d1; text-shadow:0 2px 34px rgba(0,0,0,.7);">{name}</h1>
  <div style="font-style:italic; font-size:16px; line-height:1.5; color:{glow}; max-width:680px; text-shadow:0 1px 12px rgba(0,0,0,.8);">{lead}</div>
  <p style="margin:14px 0 0; max-width:680px; font-size:18px; line-height:1.6; color:rgba(233,223,201,.96); text-shadow:0 1px 14px rgba(0,0,0,.85);">{essence}</p>
 </div>
</section>
